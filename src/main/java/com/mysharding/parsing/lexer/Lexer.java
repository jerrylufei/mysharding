...
import com.mysharding.parsing.lexer.analyzer.CharType;
import com.mysharding.parsing.lexer.analyzer.Tokenizer;
...
public class Lexer {
  ...
  public static void main(String[] args) {
    Lexer lexer = new Lexer(null, null);
    while (lexer.getOffset() <= lexer.getInput().length()) {
      lexer.nextToken();
      System.out.println(lexer.getCurrentToken().getLiterals());
    }
  }
